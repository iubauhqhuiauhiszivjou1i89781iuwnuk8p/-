...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Devil Ugly Scripts"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Devil Ugly Scripts"
	...
	local function LoadSequence()
		...
		local LoadSequenceText2 = SetProps(MakeElement("Label", "by _Rezyc", 14), {
			Parent = Orion,
			Size = UDim2.new(1, 0, 1, 0),
			AnchorPoint = Vector2.new(0.5, 0.5),
